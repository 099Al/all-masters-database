...
create temporary table tmp_moved on commit drop as
    select ms.specialist_id, ms.service_id, s.category_id
...
insert into specialist_services (specialist_id, category_id, service_id)
select specialist_id, category_id, service_id
from tmp_moved;
...
where ms.specialist_id = t.specialist_id
  ...
  and ms.category_id = t.category_id;
